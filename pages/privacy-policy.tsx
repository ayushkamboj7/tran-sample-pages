  ...
  return (
    <>
      <section className="m-2">
        ...
        <p>
          <strong>Last updated&nbsp;February 03, 2023</strong>
        </p>
        <p>
          This privacy notice for&nbsp;S V Ispat Pvt Ltd&nbsp;("
        ...
        <ul>
          <li>
            Download and use&nbsp;our mobile application&nbsp;(Tran),&nbsp;or
        ...
        <p>
          ...
          contact us at&nbsp;pune@svispat.com.
        </p>
        <p>
        ...
        <p>
          ...
          information depending on how you interact with&nbsp;S V Ispat Pvt
          Ltd&nbsp;and the Services, the choices you make, and the products and
          features you use. Click&nbsp;<a href="#personalinfo">here</a> to learn
          more.
        </p>
        <p>
        ...
        <p>
          ...
          specific&nbsp;third parties. Click&nbsp;<a href="#whoshare">here</a>{" "}
          to learn more.
        </p>
        <p>
        ...
        <p>
          ...
          available&nbsp;here:&nbsp;pune@svispat.com, or by contacting us. We
          will consider and act upon any request in accordance with applicable
          data protection laws.
        </p>
        <p>
          Want to learn more about what&nbsp;S V Ispat Pvt Ltd&nbsp;does with
        ...
        <p>
          ...
          please contact us at&nbsp;pune@svispat.com.
        </p>
        <p>
        ...
        <p>
          ...
          may&nbsp;email us at&nbsp;pune@svispat.com&nbsp;or by post to:
        </p>
        <p>S V Ispat Pvt Ltd</p>
        <p>250, Marvel Vista</p>
        <p>Lullanagar</p>
        <p>Pune,&nbsp;Maharashtra&nbsp;411040</p>
        <p>India</p>
        <p>
          <strong>
            12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM
        ...
        <p>
          ...
          or delete your personal information, please visit: pune@svispat.com.
        </p>
      </section>
    </>
  );
